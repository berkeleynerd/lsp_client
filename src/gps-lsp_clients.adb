...
package body GPS.LSP_Clients is
   ...
   is
      ...
      --  "method", "error", and "result". First two are unparsed too.
   ...
   overriding procedure On_Started (Self : in out LSP_Client) is
      ...
      begin
         GNATCOLL.JSON.Append (Refactorings, Create ("add_parameter"));
   ...
   is
      ...
      begin
         --  Allocate and set id of the request and add it to the map.
