--  Configuration for gps_lsp_client_core generated by Alire
pragma Restrictions (No_Elaboration_Code);
pragma Style_Checks (Off);

package Gps_Lsp_Client_Core_Config is
   pragma Pure;

   Crate_Version : constant String := "0.1.0-dev";
   Crate_Name : constant String := "gps_lsp_client_core";
...
end Gps_Lsp_Client_Core_Config;
